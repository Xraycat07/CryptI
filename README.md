...
| `GET /api/candles/:coin?interval=1d&limit=365` | OHLC candles (Binance) — used by the charts |
...
- CoinGecko's free tier rate-limits fairly aggressively; `/api/candles` uses Binance instead for that reason.
